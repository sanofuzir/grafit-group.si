...
class __TwigTemplate_a3b989f5b70147fe8b82bb1cc4e964ffd68dee84383d8a877ffddfe8fe0b0cb8 extends Twig_Template
{
    ...
    {
        // line 6
        echo "<h2 style=\"margin-top: 50px;\" class=\"title\">Dodajanje in urejanje Kategorije</h2>
<form class=\"border category_form\" action=\"";
        // line 7
        echo twig_escape_filter($this->env, (($this->getAttribute((isset($context["category"]) ? $context["category"] : null), "id")) ? ($this->env->getExtension('routing')->getPath("_admin_edit_category", array("id" => $this->getAttribute((isset($context["category"]) ? $context["category"] : null), "id")))) : ($this->env->getExtension('routing')->getPath("_admin_add_category"))), "html", null, true);
        echo "\" method=\"post\" ";
