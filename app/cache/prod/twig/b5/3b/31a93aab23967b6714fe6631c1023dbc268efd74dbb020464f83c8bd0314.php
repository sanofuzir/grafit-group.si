...
<form class=\"border text_form\" action=\"";
        // line 7
        echo twig_escape_filter($this->env, (($this->getAttribute((isset($context["items"]) ? $context["items"] : null), "id")) ? ($this->env->getExtension('routing')->getPath("_admin_edit_text", array("id" => $this->getAttribute((isset($context["items"]) ? $context["items"] : null), "id")))) : ($this->env->getExtension('routing')->getPath("_admin_add_text"))), "html", null, true);
        echo "\" method=\"post\" ";
