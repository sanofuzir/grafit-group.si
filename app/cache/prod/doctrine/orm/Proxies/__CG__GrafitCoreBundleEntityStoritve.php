 ...
 */
class Storitve extends \Grafit\CoreBundle\Entity\Storitve implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'name', 'text', 'file', 'path', 'size', 'created');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Storitve $proxy) {
