 ...
 */
class News extends \Grafit\CoreBundle\Entity\News implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', '' . "\0" . 'Grafit\\CoreBundle\\Entity\\News' . "\0" . 'name', 'file', 'path', 'size', 'actual', 'created', 'text');
        }
