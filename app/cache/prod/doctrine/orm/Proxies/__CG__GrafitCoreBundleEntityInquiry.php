 ...
 */
class Inquiry extends \Grafit\CoreBundle\Entity\Inquiry implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', '' . "\0" . 'Grafit\\CoreBundle\\Entity\\Inquiry' . "\0" . 'name', '' . "\0" . 'Grafit\\CoreBundle\\Entity\\Inquiry' . "\0" . 'surname', '' . "\0" . 'Grafit\\CoreBundle\\Entity\\Inquiry' . "\0" . 'company', '' . "\0" . 'Grafit\\CoreBundle\\Entity\\Inquiry' . "\0" . 'telephone', '' . "\0" . 'Grafit\\CoreBundle\\Entity\\Inquiry' . "\0" . 'email', '' . "\0" . 'Grafit\\CoreBundle\\Entity\\Inquiry' . "\0" . 'status', 'text', 'created');
        }
